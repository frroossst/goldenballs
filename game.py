...
fp1r2.close()
print(r2p1,"check the file with your name on it to see the backrow")
p1brow1=input("reveal your first ball : ")
p1brow2=input("reveal your second ball : ")
p1brow3=input("reveal your third ball : ")
print("revealing backrow for",r2p1)
print(p1brow1)
print(p1brow2)
print(p1brow3)
...
fp2r2.close()
print(r2p2,"check the file with your name on it to see the backrow")
p2brow1=input("reveal your first ball : ")
p2brow2=input("reveal your second ball : ")
p2brow3=input("reveal your third ball : ")
print("revealing backrow for",r2p2)
print(p2brow1)
print(p2brow2)
print(p2brow3)
...
fp3r2.close()
print(r2p3,"check the file with your name on it to see the backrow")
p3brow1=input("reveal your first ball : ")
p3brow2=input("reveal your second ball : ")
p3brow3=input("reveal your third ball : ")
print("revealing backrow for",r2p3)
print(p3brow1)
print(p3brow2)
print(p3brow3)
